          ...
          <Card className="overflow-hidden text-center rounded-4 p-xxl-4 p-3">
            ...
            <div className="mx-auto text-center">
              <Image
                ...
                className="my-3"
              />
              <h3 className="fw-bold mt-3 text-primary lh-base">
                Server Error
              </h3>
              <h4 className="fw-medium mt-2 text-dark lh-base">
                Ohh Noo ! Seem like our servers are lost
              </h4>
              <p className="text-muted mb-3">
                Our internal server has gone on a uninformed vacation. And, we
                are trying our best to bring it back online.
              </p>
