          ...
          <Card className="overflow-hidden text-center rounded-4 p-xxl-4 p-3">
            ...
            <div className="mx-auto text-center">
              <Image
                ...
                className="my-3"
              />
              <h2 className="fw-bold mt-3 text-primary lh-base">
                Page Not Found !
              </h2>
              <h4 className="fw-medium mt-2 text-dark lh-base">
                Something's Missing...! This page is not available
              </h4>
              <p className="text-muted mb-3">
                Sorry, we can't find the page you're looking for We suggest you
                to go homepage
              </p>
