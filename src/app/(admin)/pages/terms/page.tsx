            ...
            <Card className="overflow-hidden">
              <CardHeader className="terms-bg bg-primary text-center p-4">
                <div className="mb-3">
                  ...
                  <span className="h4 fw-semibold text-white">
            ...
            <Row>
                ...
                <Card>
                  ...
                  <CardBody>
                    <p>
                      ...
                      behalf of an entity you and Space we, concerning your
                      access to and use of the space.com website as well as any
                ...
                <Card>
                  ...
                  <CardBody>
                    ...
                    <p className="mb-0">
                      ...
                      information and to improve aur Service. You have the
                      option to either accept or refuse these cookies, and know
                      when a cookie is being sent to your computer. If you
                    ...
                    <ol className="ps-3 d-flex flex-column gap-1">
                      <li>
                        <p className="mb-0">
                          ...
                          <Link href="">ocenbycoderthemes@mail.com</Link>
                        </p>
                      </li>
                      <li>
                        <p className="mb-0">
                      ...
                      <li>
                        <p className="mb-0">
                          ...
                          <Link href="">
                            3469 Beech Street Oakland, CA 94607
                          </Link>
                        </p>
                      </li>
                    </ol>
              ...
              <Col xl={6} lg={12}>
                ...
                <Card>
                  ...
                  <CardBody>
                    <p className="mb-1">
                      Coderthemes will not be liable for any damages arising
