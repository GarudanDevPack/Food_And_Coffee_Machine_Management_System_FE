...
const DefaultTabs = () => {
  return (
    <ComponentContainerCard
      title="Default Tabs"
      description={<>Simple widget of tabbable panes of local content.</>}
    >
    ...
    >
      <TabContainer defaultActiveKey="Profile">
        <Nav
          ...
          variant="pills"
          role="tablist"
          className="bg-nav-pills nav-justified mb-3"
        >
          {(tabContents || []).map((tab, idx) => {
            return (
      ...
      <Row>
        <TabContainer defaultActiveKey="Profile">
          ...
          <Col sm={3} className="mt-2 mt-sm-0">
            <Nav
              role="tablist"
              className="flex-column nav-pills nav-pills-secondary"
            >
              {(tabContents || []).map((tab, idx) => {
                return (
                  <NavItem as="li" role="presentation" key={idx}>
  ...
  return (
    ...
    >
      <TabContainer defaultActiveKey="Profile">
        <Nav
          role="tablist"
          className="nav-tabs nav-justified nav-bordered nav-bordered-danger mb-3"
        >
          {(tabContents || []).map((tab, idx) => {
            return (
              <NavItem as="li" role="presentation" key={idx}>
  ...
  return (
    ...
    >
      <TabContainer defaultActiveKey={"2"}>
        <Nav
          role="tablist"
          className="nav-tabs nav-bordered nav-bordered-success mb-3"
        >
          <NavItem>
        ...
        <TabContent>
          <TabPane eventKey={"1"}>
            <p className="mb-0">
              <span className="px-1 rounded me-1 fw-semibold d-inline-block bg-info-subtle text-info float-start">
                H
              </span>
              Welcome to our website! We are dedicated to providing you with the
              best products and services to enhance your home. Whether
              you&apos;re looking to spruce up your living space with stylish
              furniture, create a cozy atmosphere with our selection of home
              decor, or tackle those DIY projects with our range of tools and
              supplies.
            </p>
          </TabPane>
          <TabPane eventKey={"2"}>
            <p className="mb-0">
              <span className="px-1 rounded me-1 fw-semibold d-inline-block bg-danger-subtle text-danger float-start">
                P
              </span>{" "}
              &quot;Hi there! I&apos;m a passionate individual who loves to
              explore new ideas and connect with like-minded people. My
              interests span a wide range of topics including technology,
              literature, travel, and fitness. I believe in the power of
              continuous learning and enjoy challenging myself to grow both
              personally and professionally.
            </p>
          </TabPane>
          <TabPane eventKey={"3"}>
            <p className="mb-0">
              <span className="px-1 rounded me-1 fw-semibold d-inline-block bg-secondary-subtle text-secondary float-start">
                S
              </span>
              In the heart of a bustling city lies a quaint little cafe, nestled
              between towering skyscrapers and historic buildings. Its cozy
              interior boasts warm, earthy tones accented with splashes of
              vibrant colors, creating a welcoming atmosphere that beckons
    ...
    <Card>
      <TabContainer defaultActiveKey={"2"}>
        <CardHeader className="card-tabs d-flex align-items-center">
          ...
          <Nav
            role="tablist"
            className="nav-tabs nav-justified card-header-tabs nav-bordered"
          >
            <NavItem>
              <NavLink
                eventKey={"1"}
            ...
            <NavItem>
              ...
              >
                <IconifyIcon
                  icon="ti-user-circle"
                  className="ti  d-md-none d-block"
                />
          ...
          <TabContent>
            <TabPane eventKey={"1"} id="home-ct">
              <p className="mb-0">
                ...
                the best products and services to enhance your home. Whether
                you&apos;re looking to spruce up your living space with stylish
                furniture, create a cozy atmosphere with our selection of home
                decor, or tackle those DIY projects with our range of tools and
                supplies.
            ...
            <TabPane eventKey={"3"} id="settings-ct">
              <p className="mb-0">
                ...
                In the heart of a bustling city lies a quaint little cafe,
                nestled between towering skyscrapers and historic buildings. Its
                cozy interior boasts warm, earthy tones accented with splashes
                of vibrant colors, creating a welcoming atmosphere that beckons
                passersby to step inside.
              </p>
            </TabPane>
          </TabContent>
