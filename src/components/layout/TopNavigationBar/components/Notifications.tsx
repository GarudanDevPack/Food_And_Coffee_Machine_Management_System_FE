            ...
            {notifications.length === 0 ? (
              <div className="text-center py-5 text-muted">
                <IconifyIcon
                  ...
                  className="fs-48 d-block mx-auto mb-2"
                />
                No notifications
              </div>
            ) : (
                  ...
                  >
                    <span className="d-flex align-items-start gap-2">
                      <div className="avatar-sm flex-shrink-0">
                        <span
                          className={`avatar-title bg-${variant}-subtle text-${variant} rounded-circle fs-18`}
                        >
                      ...
                      <span className="flex-grow-1">
                        <span
                          className={`d-block fw-semibold fs-13 ${!n.isRead ? "text-dark" : "text-muted"}`}
                        >
                          {n.title}
                        </span>
                        <span className="d-block text-muted fs-12 text-wrap">
                          {n.message}
                        </span>
